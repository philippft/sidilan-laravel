         ...
         <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
            <div class="w-full lg:w-1/2 flex flex-col justify-between order-1 lg:order-2">
               ...
               <div class="hidden lg:flex flex-col gap-2 mt-0">
                  ...
                  <a class="block w-full py-4 text-center font-bold text-2xl text-white rounded-lg bg-danger hover:bg-[#cf4c4c]"
                     href="{{ url('admin/management-data') }}">
                     Batal
                  </a>
               </div>
            </div>
            ...
            <div class="w-full lg:w-1/2 order-2 lg:order-1">
               <div class="flex flex-col justify-between">
                  <x-textField label="Nama Lengkap" type="text" name="full_name" id="full_name" :value="$person->full_name"
                     placeholder="Masukkan Nama Lengkap..." />
                  <x-textField label="NIP" type="text" name="nip" id="nip" :value="$person->nip"
...
{{-- 
   ...
   Laboran (2)
   Teknisi (3)
   Kepala Laboratorium (6)
   Koordinator Praktikum (7)
--}}
<script>
