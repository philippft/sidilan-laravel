    ...
    <div class="w-full flex justify-between items-center h-screen bg-background-sidilan">
        <div class="flex flex-col justify-center w-full px-12 md:px-16 md:py-4">
            ...
            <form action="{{ url('admin/login') }}" method="post" class="justify-center">
                @csrf
                <p class="font-medium text-md md:text-xl mb-2">Username</p>
                <div class="relative">
                    ...
                    <x-textField type="text" name="username" id="username" placeholder="Username" class="border-abu-sidilan h-10 md:h-14 pl-10 rounded-md md:rounded-xl"/>
                </div>
                <p class="font-medium text-md md:text-xl mb-2 mt-2">Password</p>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <x-textField type="password" name="password" id="username" placeholder="Password" class="border-abu-sidilan h-10 md:h-14 pl-10 rounded-md md:rounded-xl"/>
                </div>
