...
<div class="flex flex-col lg:flex-row  lg:mt-6 mt-4 gap-4 justify-end lg:justify-between items-center">
    ...
    <div class="flex justify-end w-full items-center">
        {{-- PREV --}}
        @if ($data->onFirstPage())
            <span class="md:px-4 px-3 md:py-2 py-1.5 bg-gray-300 text-white rounded-l-lg cursor-not-allowed flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="size-4 md:size-6">
        ...
        @else
            <span class="md:px-4 px-3 md:py-2 py-1.5 bg-gray-300 text-white rounded-r-lg cursor-not-allowed flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="size-4 md:size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                </svg>
            </span>
