...
>
    ...
    <x-button
        type="button"
        @click="submit"
        class="bg-dongker-sidilan text-white lg:h-13 h-9 lg:px-6 px-3 lg:py-2 py-1 rounded-xl focus:outline-none focus:ring-1 items-center focus:ring-abu-sidilan"
    >
