    ...
    <div>
        ...
        <form method="GET" class="mt-3 flex items-center gap-2 font-medium text-sm text-black">
            ...
            <select
                ...
                class="border px-1 py-0.5 focus:outline-none"
            >
...
@if ($plpTeknisiLab->count())
    @foreach ($plpTeknisiLab as $item)
        <div class="bg-white w-full text-base text-black h-19 rounded-xl shadow-lg px-5 py-3 mt-4 flex justify-between items-center">
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 flex items-center mr-3">
