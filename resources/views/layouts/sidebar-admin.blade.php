...
<body>
   <div class="md:w-full w-full md:flex bg-background-sidilan font-poppins" x-data="{ open: false }">
      ...
      <div
         class="md:w-[300px] w-full h-auto md:h-screen font-poppins relative bg-dongker-sidilan flex md:flex-col justify-between py-4 md:py-8 sticky top-0 z-50">
            ...
            <div x-show="open"
               ...
               <div class="flex flex-col gap-4">
                  ...
                  <x-nav-link href="{{ route('admin.dashboard') }}" :active="request()->routeIs('admin.dashboard')"
                     ...
                     <div
                        class="h-[72px] md:px-5 px-4 gap-2 text-right flex items-center md:justify-left hover:bg-hover-sidilan active:bg-sikuning-sidilan rounded-md md:rounded-none">
                  ...
                  <x-nav-link href="{{ route('admin.management-data') }}" :active="request()->routeIs('admin.management-data')"
                     activeClass="bg-hover-sidilan hover:bg-hover-sidilan">
                     <div
                        class="h-[72px] md:px-5 px-4 gap-2 text-center flex items-center justify-left hover:bg-hover-sidilan active:bg-sikuning-sidilan rounded-md md:rounded-none">
                        <svg class="md:size-8 size-6" viewBox="0 0 32 32" fill="none"
                           xmlns="http://www.w3.org/2000/svg">
                           <path d="M18.6668 20L13.3335 25.3333L18.6668 30.6667" stroke="#FDFDFD"
                           ...
                           <path d="M13.3332 12L18.6665 6.66667L13.3332 1.33333" stroke="#FDFDFD"
                              stroke-width="2.66667" />
                           <path
                        ...
                        <p class="font-poppins md:font-bold font-medium md:text-xl text-lg text-white">Management Data
                        </p>
                     </div>
                  </x-nav-link>
               </div>
